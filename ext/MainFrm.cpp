...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	lstBasicCommands.AddTail(ID_DATA_PARSE);
	lstBasicCommands.AddTail(ID_DATA_SAVE);
	lstBasicCommands.AddTail(ID_DATA_LOAD);
	lstBasicCommands.AddTail(ID_DO_ROUTE);
