...
#if ((_MSC_VER <= 1200) || (_WIN32_WCE >= 400))
...
////////////////////////////////////////////////////////////////////////////////
        ...
        class LifetimeTracker {
        public:
            LifetimeTracker(unsigned int x) : longevity_(x) //NOLINT
            {}
...
////////////////////////////////////////////////////////////////////////////////
    ...
    void SetLongevity(T* pDynObject, unsigned int longevity,
        ...
        using namespace Private; //NOLINT
        
        TrackerArray pNewArray = static_cast<TrackerArray>(
                VC_BROKEN_STD::realloc(pTrackerArray, 
...
#pragma warning(disable : 4121)
    ...
    union MaxAlign {
     ...
     float float_;
     double double_;
     double longDouble_; //long double
     struct Test;
     int Test::* pMember_;
     int (Test::*pMemberFn_)(int in);
    };
#ifdef _MSC_VER
#pragma warning(pop)
#endif // _MSC_VER
...
////////////////////////////////////////////////////////////////////////////////
  namespace {//NOLINT
    void Thrower(const char* s) {
      VC_USING_STD::string t(s);
      throw VC_USING_STD::logic_error(t);
    }
  }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    void SingletonHolder<T, CreationPolicy, 
        ...
        //class Apply1<ThreadingModel, T>::Lock guard;
