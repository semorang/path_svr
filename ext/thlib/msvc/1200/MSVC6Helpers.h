...
////////////////////////////////////////////////////////////////////////////////
    ...
    struct ApplyImpl1 {
      ...
      template<class T1> struct Result : public
      VC_WORKAROUND< ::Loki::
        Private::AlwaysFalse<TypeWithNestedTemplate>::value >::template In<T1> {
        typedef VC_WORKAROUND< ::Loki::
          Private::AlwaysFalse<TypeWithNestedTemplate>::value >::
          template In<T1> Base;
      };
    };
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
    ...
    struct ApplyImpl2 {
      ...
      template<class T1, class T2> struct Result : public
      VC_WORKAROUND< ::Loki::
        Private::AlwaysFalse<TypeWithNestedTemplate>::value >::
                                                template In<T1, T2> {
      };
...
////////////////////////////////////////////////////////////////////////////////
  ...
  struct Apply1 : ::Loki::Private::ApplyImpl1<F>::template Result<T1> {
    typedef typename ::Loki::
      Private::ApplyImpl1<F>::template Result<T1>::Base Base;
  };
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  struct Apply2 : ::Loki::
          Private::ApplyImpl2<F>::template Result<T1, T2> {
  };

////////////////////////////////////////////////////////////////////////////////
// class template ApplyInnerType
// Invocation: ApplyInnerType<Wrapper, U>::type
// Applies the type U to the the inner template 'In' 
// of type Wrapper and typedefs
// the resulting type to 'type'
// The class template ApplyInnerType helps to 
// emulate template template parameters
// i first saw this technique in boost's mpl library.
////////////////////////////////////////////////////////////////////////////////
  template <class Wrapper1, class T>
  struct ApplyInnerType {
    template<bool> struct Wrapper_VC : Wrapper1 {};
    ...
    typedef typename
    Wrapper_VC< ::Loki::
    Private::AlwaysFalse<Wrapper1>::value>::template In<T>::type type;
  };
////////////////////////////////////////////////////////////////////////////////
// class template ApplyInnerType2
// Invocation: ApplyInnerType2<Wrapper, U, V>::type
// Applies the types U and V to the the inner template 
//  'In' of type Wrapper and typedefs
// the resulting type to 'type'
// The class template ApplyInnerType helps to emulate 
//  template template parameters
// i first saw this technique in boost's mpl library.
////////////////////////////////////////////////////////////////////////////////
  template <class Wrapper1, class T, class V>
  struct ApplyInnerType2 {
    ...
    typedef typename
    Wrapper_VC< ::Loki::
    Private::AlwaysFalse<Wrapper1>::value>::template In<T, V>::type type;
  };

  template <class Wrapper1, class T, class U, class V, class W>
  struct ApplyInnerType4 {
    ...
    typedef typename
    Wrapper_VC< ::Loki::
    Private::AlwaysFalse<Wrapper1>::value>::template In<T, U, V, W>::type type;
  };
}
#endif
