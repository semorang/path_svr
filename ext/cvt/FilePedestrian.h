...
struct stWalkNode
{
	...
	uint32_t FctNameIDX; // 시설물 상세 명칭사전 인덱스
	...
	uint32_t FctPhase : 2; // 시설물 위상, 0:미정의, 1:지하, 2:지상, 3:
...
struct stWalkLink
{
	...
	//BYTE BicycleType; // 자전거도로 타입, 1:자전거전용, 2:보행자/차량겸용 자전거도로, 3:보행도로
	//BYTE WalkType; //보행자도로 타입, 1:복선도로, 2:차량겸용도로, 3:자전거전용도로, 4:보행전용도로, 5:가상보행도로
	...
	//BYTE BicycleControl; // 자전거도로 규제 코드, 0:양방향, 1:정방향, 2:역방향, 3:통행불가
	uint32_t BicycleType : 2; // 자전거도로 타입, 1:자전거전용, 2:보행자/차량겸용 자전거도로, 3:보행도로
	uint32_t WalkType : 3; //보행자도로 타입, 1:복선도로, 2:차량겸용도로, 3:자전거전용도로, 4:보행전용도로, 5:가상보행도로
